...
@mcp.tool()
def get_daily_snapshot(date: str, **kwargs) -> str:
    """
...
@mcp.tool()
def get_readiness_breakdown(date: str, **kwargs) -> str:
    """
...
@mcp.tool()
def get_sleep_consistency(days: int = 30, **kwargs) -> str:
    """
...
@mcp.tool()
def get_workout_history(start_date: str, end_date: str, **kwargs) -> str:
    """
...
@mcp.tool()
def get_comparative_trends(metric: str, period_1_days: int = 7, period_2_days: int = 30, **kwargs) -> str:
    """
...
@mcp.tool()
def analyze_correlation(metric_a: str, metric_b: str, days: int = 60, **kwargs) -> str:
    """
